...
1. Requirement Analysis:
  ...
  Planning the conversion of core chemistry concepts (elements, molar mass, bonding) into a digital tool.
  
2.Data Modeling:

Creating a structured database of elements including name, atomic mass and electronegativity.
...
Included Elements: Hydrogen, Oxygen, Sodium, Chlorine, and Carbon.
...
* **Input:** Na
* **Output:** Symbol: Na, Name: Sodium, Mass: 22.99, Group: Metal, Electronegativity: 0.93"
